...
\subfile{Chuong/3_Phan_tich_thiet_ke_he_thong}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{HUẤN LUYỆN MÔ HÌNH}
\label{chapter:Experiment}
\subfile{Chuong/4_Huan_luyen_mo_hinh}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{THỰC NGHIỆM VÀ ĐÁNH GIÁ}
\label{chapter:SolutionAndContribution}
\subfile{Chuong/5_Thuc_nghiem_va_danh_gia}
\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{XÂY DỰNG ỨNG DỤNG THỬ NGHIỆM} %Kết luận và hướng phát triển}
\label{chapter:conclusion}
\subfile{Chuong/6_Xay_dung_ung_dung}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{KẾT LUẬN VÀ HƯỚNG PHÁT TRIỂN} %Kết luận và hướng phát triển}
\label{chapter:reference}
\subfile{Chuong/7_Ket_luan_va_huong_phat_trien}
